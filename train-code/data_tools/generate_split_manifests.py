...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="根据 canonical manifest 生成按数据源均衡的 train/val/holdout split manifests。"
    )
    ...
    parser.add_argument(
        "--trainval-name",
        default="trainval_balanced.split.csv",
        help="train/val split manifest 文件名。",
    )
    parser.add_argument(
        "--holdout-name",
        default="holdout.split.csv",
...
def main() -> int:
    ...
    try:
        ...
        write_split_manifest(
            ...
            notes_by_split={
                "train": "source_balanced_trainval",
                "val": "source_balanced_trainval",
                "skip": "reserved_for_holdout",
            },
            holdout_group_name="",
        )
        write_split_manifest(
            ...
            notes_by_split={
                "test": "holdout",
                "skip": "reserved_for_trainval_balanced",
            },
            holdout_group_name="holdout",
        )
